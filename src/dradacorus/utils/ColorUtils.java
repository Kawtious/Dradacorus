 ...
 * <p>
 * The part of looking up a color name from the rgb values is edited from https://gist.github.com/nightlark/6482130#file-gistfile1-java (that has some errors) by Ryan Mast (nightlark)
 *
 * @author Xiaoxiao Li
 *
 */
public class ColorUtils {
    ...
    public static String getRandomColorName() {
        return getColorNameFromColor(getRandomColor());
    }

    public static String getRandomPastelColorName() {
        return getColorNameFromColor(getRandomPastelColor());
    }
